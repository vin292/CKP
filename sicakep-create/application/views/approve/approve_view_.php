        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-xs-12" align="right">
            <form class="form-inline" style="padding-bottom:10px">
              <div class="form-group" style="margin-bottom:0px;">
                <select class="form-control" id="selectPegawai" style="width:250px; align: right">
    ...
    function setuju_target(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('[name="id_keg_target"]').val(data.id_keg).trigger("change");;
    ...
    function setuju(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('[name="id_keg"]').val(data.id_keg).trigger("change");;
                        ...
                        <select name="niplama" data-placeholder="pilih nama pegawai"  class="form-control list_pegawai" tabindex="1" style="width: 100%;">
                            ...
                            <?php } ?>
									...
									<div class="form-group">
											...
											<div class="col-md-9">
												<select name="id_keg" data-placeholder="pilih uraian kegiatan"  class="form-control list_keg" tabindex="1" style="width: 100%;">
														<option value=""></option>
                        ...
                        <select name="niplama_target" data-placeholder="pilih nama pegawai"  class="form-control list_pegawai" tabindex="1" style="width: 100%;">
                            ...
                            <?php } ?>
									...
									<div class="form-group">
											<label class="control-label col-md-3">Uraian Kegiatan</label>
											<div class="col-md-9">
												<select name="id_keg_target" data-placeholder="pilih uraian kegiatan"  class="form-control list_keg" tabindex="1" style="width: 100%;">
														<option value=""></option>
														<?php foreach ($kegiatan as $row) { ?>
															<option value="<?php echo $row->id; ?>"><?php echo $row->n_keg; ?></option>
														<?php } ?>
