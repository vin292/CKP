        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <?php }else{ ?>
                <?php if($data[$x]['ckp']>100){ ?>
                  <td style="text-align:center"><?php echo number_format(100, 2, '.', ' '); ?></td>
                <?php }else{ ?>
