  <div class="row" style="margin:20px">
    <div >
    <form action="<?=base_url();?>ckp/simpan_target" method="POST" id="form_keg" class="form-horizontal">
        ...
        <tr>
          ...
          <td colspan="5">
              <div class="input-group date" id="tgl_ckp">
                  <input id="bulan_ckp" name="bulan_ckp" placeholder="" class="form-control" type="text" readonly>	
...
<script type="text/javascript">
     ...
     function tambah_kegiatan() {
       idx++;
       $('#dynamic_field').append('<tr id="row'+idx+'"><td>'+idx+'</td><td><input type="text" name="nm_kegiatan[]" placeholder="Nama Kegiatan" class="form-control" required/></td><td width="150px"><input type="text" name="target[]" placeholder="Target Kegiatan" class="form-control" /></td><td width="150px"><input type="text" name="satuan[]" placeholder="Satuan Kegiatan" class="form-control" /></td><td width="150px"><select name="jenis[]" class="form-control" tabindex="1" style="width: 100%;"><option value="1">Utama</option><option value="0">Tambahan</option></select></td><td width="10px"><button type="button" name="remove" id="'+idx+'" class="btn btn-danger btn_remove">X</button></td></tr>');
